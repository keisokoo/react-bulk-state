...
var useBulkState = function (initialValue) {
    ...
    var setByPath = (0, react_1.useCallback)(function (target, value, recipe) {
        set_value(function (prev) {
            var changedValue = (0, immer_1.produce)(prev, function (draft) {
                if (typeof value === 'function' && propsToPreviousCallback(value)) {
                    (0, lodash_es_1.set)(draft, target, value((0, lodash_es_1.get)(draft, target), prev));
                }
                else {
                    (0, lodash_es_1.set)(draft, target, value);
                }
            });
            if (recipe) {
